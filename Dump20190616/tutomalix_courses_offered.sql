...
CREATE TABLE `courses_offered` (
  `CourseType` varchar(45) NOT NULL COMMENT 'Will contain 3 Rows : 1. Coding\n                                   2.Gaming\n                                   3. 3D',
  PRIMARY KEY (`CourseType`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Contains the courses offered';
...
INSERT INTO `courses_offered` VALUES ('3D'),('Coding'),('Gaming');
